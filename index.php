...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <form action="forms/registerProcess.php" method="post">
        <div class="container">
          <h1>Register Here!</h1>
          ...
          <input type="text" placeholder="Enter First Name" name="vnaam" required>

          <label for="suffix"><b>suffix</b></label>
          <input type="text" placeholder="Enter Suffix" name="suffix">

          <label for="lnaam"><b>Last Name</b></label>
          <input type="text" placeholder="Enter Last Name" name="lnaam" required>
          ...
          <p> Already a member? <a href="loginpage.php"><strong>Login</strong></a></p>
        </div>
      </form> 
